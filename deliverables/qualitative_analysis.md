...
| Theme | Freq (n) | % of answered | Paraphrased insight | Product implication |
|---|---|---|---|---|
| Better / more personalised recommendations | 13 | 37.1% | The largest single group asked for recommendations more closely matched to their own taste and watch history, several explicitly contrasting this with the prototype's current suggestions. | Recommendation relevance is the single biggest lever on stated adoption — consistent with the weak 29.4%(prior report)/current-data top-box headline desirability; this is the primary 'improve' target, not a new component. |
